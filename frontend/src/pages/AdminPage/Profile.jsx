  ...
  return (
    <div className="w-full bg-[#f8fafc] p-4 md:p-6 font-sans flex flex-col gap-6 min-h-screen">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
        ...
        {/* Banner */}
        <div className="h-28 sm:h-36 bg-gradient-to-r from-[#3a0f08] to-[#db6747] relative" />
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 -mt-12 sm:-mt-14">
            ...
            <div className="relative w-24 h-24 sm:w-28 sm:h-28 shrink-0">
              {profile?.profilePicture ? (
                ...
                <div className="w-full h-full rounded-2xl bg-gradient-to-tr from-[#3a0f08] to-[#db6747] flex items-center justify-center border-4 border-white shadow-lg">
              ...
              <button
                ...
                disabled={uploading}
                className="absolute -bottom-2 -right-2 w-8 h-8 bg-[#db6747] hover:bg-[#c45a3a] text-white rounded-full flex items-center justify-center shadow-md transition-colors disabled:opacity-60"
                title="Change photo"
              >
                {uploading
            ...
            <div className="flex-1 min-w-0 mt-2 sm:mt-0 sm:pb-1">
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">{profile?.role ?? "Admin"}</span>
                <span className="text-slate-200">·</span>
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">{profile?.adminID}</span>
              </div>
            </div>
